...
mdl3 = sm.Logit.from_formula('Default_Dum ~ equity_ratio + bank_liab_lt + roa + debt_ratio + current_ratio + receivables_payables', data=indicators).fit(disp=False, maxiter=100)
